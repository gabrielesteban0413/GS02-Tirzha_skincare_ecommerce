...
export default function CartPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(251,215,203,0.35),_transparent_55%)]">
      <Navbar />
      <div className="mx-auto max-w-6xl px-4 pb-16 pt-28 sm:px-6 lg:px-8 lg:pt-32">
        <div className="mb-10">
        ...
        {items.length === 0 ? (
          <div className="rounded-[2rem] border border-[#f2d9d1] bg-[#fff9f8] p-10 text-center shadow-sm">
            <p className="text-lg text-gray-700">Tu carrito está vacío.</p>
            <p className="mt-3 text-sm text-gray-500">Explora nuestros tratamientos y agrega tus favoritos para armar tu rutina ideal.</p>
            <Link href="/productos" className="mt-6 inline-flex rounded-full bg-[#c05264] px-6 py-3 text-white transition-colors hover:bg-[#a84354]">
              Ver productos
            </Link>
          </div>
        ) : (
          <div className="space-y-8">
            ...
            <div className="flex flex-col gap-4 rounded-[2rem] border border-[#f2d9d1] bg-white p-6 shadow-sm sm:flex-row sm:items-center sm:justify-between">
              <div>
