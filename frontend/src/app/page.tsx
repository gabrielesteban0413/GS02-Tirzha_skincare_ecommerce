...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Hero Section (igual que lo tenías) */}
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="flex items-center gap-4 pt-2 md:pt-4">
                <span className="text-gray-400 text-sm md:text-base">{HERO_CONTENT.priceLabel}</span>
          ...
          {!loading && featuredProducts.length > 0 && (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
              {featuredProducts.map((product: any) => (
                <div key={product.id} className="group cursor-pointer" onClick={() => router.push(`/productos/${product.slug}`)}>
