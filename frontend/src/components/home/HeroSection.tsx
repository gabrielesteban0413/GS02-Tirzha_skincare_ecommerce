        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            <h1 className="font-['Cormorant_Garamond'] text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-light leading-tight tracking-tight">
              ...
              <span className="block font-semibold mt-2 md:mt-3 text-[#c05264]">
                {highlight}
              </span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-3 md:gap-4 pt-2 md:pt-4">
              <button
                ...
                className="bg-[#c05264] text-white hover:bg-[#a84354] rounded-full px-6 md:px-8 py-2 md:py-3 text-sm md:text-base transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg cursor-pointer"
              >
                {ctaPrimary}
              </button>
              <button
